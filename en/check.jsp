...
<%
	...
	if ((String) request.getAttribute("javax.servlet.request.ssl_session") == null	){
		String redirectURL = "http://eidtsttom.pmlp.gov.lv/en/";
		...
		if (certChain != null) {  
			...
			for(Rdn rdn: ldapDN.getRdns()) {
				if (rdn.getType().toString().equals("CN")) {
					out.println ("<h1>"+ rdn.getValue() +", Your eID-LV works correctly!</h1>,<br>");
					out.println ("We have read this information from authentication certificate included in Your eID-LV: <br>");
					out.println ("Name, surname:"+ rdn.getValue() +"<br>");	
				} 	
			}
			
			out.println ("Authentication certificate expiry date:  ");
